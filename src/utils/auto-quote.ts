import type { Context, Middleware, NextFunction, Transformer } from "grammy";
 ...
 */
export function addReplyParam<C extends Context>(ctx: C, options?: AutoQuoteOptions): Transformer {
